...
function setLabelColumnWidth(param_width)
{
    ...
    var label_div = body_tag.childNodes[1].childNodes[1].childNodes[0].childNodes[1].childNodes[0].childNodes[0];
    var message_div = body_tag.childNodes[1].childNodes[1].childNodes[0].childNodes[1].childNodes[0].childNodes[1];
